  ...
  return (
    <div className="section-card">
      ...
      <div className="space-y-6">
        <div>
          <h3 className="text-lg font-semibold mb-4">ATS Exerciser</h3>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            <div>
              ...
              <input
                ...
                disabled={readOnly}
                className={getInputClass(formData.battery_date, false, readOnly)}
              />
            </div>
            <div>
              ...
              <input
                ...
                disabled={readOnly}
                className={getInputClass(formData.battery_type, false, readOnly)}
              />
            </div>
            <div>
              ...
              <input
                ...
                onChange={(e) => onChange('battery_charger_volts', e.target.value ? parseFloat(e.target.value) : undefined)}
                disabled={readOnly}
                className={getInputClass(formData.battery_charger_volts, false, readOnly)}
              />
            </div>
          </div>
        </div>
